...
<div id="form-main">
    <div id="form-div">
        <form class="form" id="form1" action="php/verify.php" method="POST">
            <h1 style="color:#000000; font-size: 20px">กรุณากรอกไอดี Buasri เพื่อยืนยันตัวตน</h1>
            <br>
            <p class="name">
                <input name="name" type="text" class="feedback-input" id="name" />
            </p>
            <div class="g-recaptcha" data-sitekey="6LcFOwoaAAAAACmKiTlwofZdSOKmm3x9-_2mlHTZ"></div>
            <br>
            <div class="submit">
        ...
        <br>
        <a class="btn btn-success" href="../index.php">ย้อนกลับ</a>
        <a class="btn btn-danger" href="../Login/index.php">Admin</a>
    </div>
</div>
