...
<nav class="navbar navbar-expand-sm bg-danger navbar-dark fixed-top">
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link" href="#top">กลับสู่ข้างบน</a>
    </li>
    
  </ul>
</nav>
    <div class="jumbotron bg-danger text-light pt-3 pb-3">
        <a class = btn>กลับสู่หน้าหลัก</a>
        <h1 class="text-center"id = "#top">ค้นหาคณะ,วิธีการมามหาลัย,บริการ</h1>
    </div>
                ...
                <div class="container">
                    <form name="search_user" id="search_user" method="POST" action="index.php">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="submit" class="btn btn-danger" id="submit" name="submit" value="ค้นหา">
                            <input type="button" class="btn btn-danger" id="resetform" name="resetform" value="ล้างข้อมูลการค้นหา">
                            </div>
                        </div>
                        ...
                        success: function(data){
                                ...
                                $.each(data, function(key, value){
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="${value.Link}"> Link </a></td>          
                                    </tr>`;
