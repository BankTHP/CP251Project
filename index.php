...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
                            href="Faculty/faculty.html">คณะต่าง ๆ | Faculty</a></li>
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
                            href="service/service.html">สถานที่บริการ</a></li>
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
                            href="update/index.php">แนะนำสถานที่หรือเพิ่มสถานที่</a></li>
                    <li>
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
                            href="search/index.php">ค้นหา</a></li>
                    <li>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#info0">
                        <div
                ...
                <!-- Portfolio Item 1-->
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#info00">
                        <div
                            class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                            <div class="portfolio-item-caption-content text-center text-white"><i
                                    class="fa fa-folder-open"></i></div>
                ...
                <div class="col-md- col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#info000">
                        <div
                            class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                            <div class="portfolio-item-caption-content text-center text-white"><i
                                    class="fa fa-folder-open"></i></div>
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#info1">
                        <div
                            class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                            <div class="portfolio-item-caption-content text-center text-white"><i
                                    class="fa fa-folder-open"></i></div>
                ...
                <!-- Portfolio Item 2-->
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#info2">
                        <div
                            class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                            <div class="portfolio-item-caption-content text-center text-white"><i
                                    class="fa fa-folder-open"></i></div>
                ...
                <!-- Portfolio Item 3-->
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#info3">
                        <div
                            class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                            <div class="portfolio-item-caption-content text-center text-white"><i
                                    class="fa fa-folder-open"></i></div>
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
                    <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#info4">
                        <div
                            class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                            <div class="portfolio-item-caption-content text-center text-white"><i
                                    class="fa fa-folder-open"></i></div>
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-md-0">
                    <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#info5">
                        <div
                            class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                            <div class="portfolio-item-caption-content text-center text-white"><i
                                    class="fa fa-folder-open"></i></div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#info6">
                        <div
                            class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                            <div class="portfolio-item-caption-content text-center text-white"><i
                                    class="fa fa-folder-open"></i></div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                        <h4 class="text-uppercase mb-4">วัตถุประสงค์</h4>
                        <p class="lead mb-0">
                            Websiteนี้ถูกทำขึ้นเพื่อ
                        </p>
                        <p class="lead mb-0">
                            เป็นการศึกษาเท่านั้น
                        </p>
                    </div>
                <!-- Footer Social Icons-->
                <div class="col-lg-4 mb-5 mb-lg-0">
    ...
    <!-- info Modal 0-->
    <div class="portfolio-modal modal fade" id="info0" tabindex="-1" role="dialog"
        aria-labelledby="info0Label" aria-hidden="true">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0"
                                    id="info0Label">Thanks for coming</h2>
                                <!-- Icon Divider-->
    ...
    <div class="portfolio-modal modal fade" id="info000" tabindex="-1" role="dialog"
        aria-labelledby="info000Label" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fas fa-times"></i></span>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <!-- info Modal - Title-->
                                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0"
                                    id="info0Label">เลือกตัวเลือกของคุณ</h2>
                                <!-- Icon Divider-->
                                ...
                                <h3>ไปด้วยรถตู้</h3>
                                <p>ขึ้นรถจากท่ารถฟิวเจอร์พาร์ค ที่ฟิวเจอร์พาร์ครังสิต</p>
                                <h3>รถยนต์ส่วนตัว</h3>
                                <p>เส้นทางที่ 1 (เส้นทางหลัก) ใช้บริการดอนเมืองโทลล์เวย์ ผ่านดอนเมือง มาลงที่ป้ายลำลูกกา (ตลาดสี่มุมเมือง) ผ่านห้าง Future Park Rangsit เข้าถนนรังสิต-นครนายก ตรงไปคลอง 16</p>
                                <p>เส้นทางที่ 2 (เส้นทางด่วน) ใช้บริการวงแหวนตะวันออก ผ่านด่านเก็บเงินธัญบุรี ลงที่ป้ายทางออกที่ 2 “นครนายก” เข้าถนนรังสิต—ครนายก บริเวณคลอง 5 ตรงไปคลอง 16</p>
                                <p>เส้นทางที่ 3 (เส้นทางหลีก) ใช้เส้นทางถนนสายลำลูกกา มุ่งหน้าไปสายบางน้ำเปรี้ยว จากนั้นสามารถตัดเข้ามาบรรจบกับสายรังสิต-องครักษ์ ถนนเชื่อมบริเวณคลอง 7 คลอง 11 คลอง 13 คลอง 14 และคลอง 16</p>

                                <!-- info Modal - Text-->
                                <a class="btn btn-primary"
                                    href="https://www.google.com/maps?saddr=Current+Location&daddr=13.989345056226888,100.61793863355602"
                                    target="_blank">
                                    รถตู้
                                </a>
                                <a class="btn btn-primary"
                                    href="https://www.google.com/maps?saddr=Current+Location&daddr=14.108082552608284, 100.9820422883539"
                                    target="_blank">
                                    รถส่วนตัว
                                </a>
    ...
    <div class="portfolio-modal modal fade" id="info00" tabindex="-1" role="dialog"
        aria-labelledby="info000Label" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
    ...
    <div class="portfolio-modal modal fade" id="info1" tabindex="-1" role="dialog"
        aria-labelledby="info1Label" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fas fa-times"></i></span>
    ...
    <!-- info Modal 2-->
    <div class="portfolio-modal modal fade" id="info2" tabindex="-1" role="dialog"
        aria-labelledby="info2Label" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fas fa-times"></i></span>
    ...
    <!-- info Modal 3-->
    <div class="portfolio-modal modal fade" id="info3" tabindex="-1" role="dialog"
        aria-labelledby="info3Label" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fas fa-times"></i></span>
    ...
    <!-- info Modal 4-->
    <div class="portfolio-modal modal fade" id="info4" tabindex="-1" role="dialog"
        aria-labelledby="info4Label" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fas fa-times"></i></span>
    ...
    <!-- info Modal 5-->
    <div class="portfolio-modal modal fade" id="info5" tabindex="-1" role="dialog"
        aria-labelledby="info5Label" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fas fa-times"></i></span>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <!-- info Modal - Title-->
                                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0"
                                    id="info5Label">Airport Rail Link</h2>
                                <!-- Icon Divider-->
                                <div class="divider-custom">
                                    <div class="divider-custom-line"></div>
                                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                                ...
                                <img class="img-fluid rounded mb-5"><iframe
                                    ...
                                    aria-hidden="false" tabindex="0"></iframe>
                                <!-- info Modal - Text-->
                                <p class="mb-5">ลงสถานีมักกะสัน และเดินทางไป mrt เพชรบุรี สามารถต่อมอเตอร์ไซค์ ค่าบริการ 15
                                    บาท</p>
                                <a class="btn btn-primary"
                                    href="https://www.google.com/maps?saddr=13.751256486094643,%20100.56077100910281&daddr=13.748612591703694,%20100.56309778196888"
                                    target="_blank">
                                    นำทาง
                                </a>
                                <button class="btn btn-primary" data-dismiss="modal">
    ...
    <!-- info Modal 6-->
    <div class="portfolio-modal modal fade" id="info6" tabindex="-1" role="dialog"
        aria-labelledby="info6Label" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fas fa-times"></i></span>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <!-- info Modal - Title-->
                                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0"
                                    id="info6Label">รถยนต์ส่วนตัว</h2>
                                <!-- Icon Divider-->
                                <div class="divider-custom">
                                    <div class="divider-custom-line"></div>
                                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
